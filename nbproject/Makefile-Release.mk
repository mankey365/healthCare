...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Imysql-connector-c-6.1.3-linux-glibc2.5-x86_64/include/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/patient.o: patient.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Imysql-connector-c-6.1.3-linux-glibc2.5-x86_64/include/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/patient.o patient.cpp

${OBJECTDIR}/person.o: person.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Imysql-connector-c-6.1.3-linux-glibc2.5-x86_64/include/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/person.o person.cpp
